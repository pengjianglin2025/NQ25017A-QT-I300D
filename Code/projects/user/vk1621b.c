...
const uint8_t seg_bgc[] = {0x05/*0*/,0x05/*1*/,0x06/*2*/,0x07/*3*/,0x07/*4*/,0x03/*5*/,0x03/*6*/,0x05/*7*/,0x07/*8*/,0x07/*9*/,0x02/*-*/,0x00/*����*/};
const uint8_t seg_afed[] = {0x0f/*0*/,0x00/*1*/,0x0b/*2*/,0x09/*3*/,0x04/*4*/,0x0d/*5*/,0x0f/*6*/,0x08/*7*/,0x0f/*8*/,0x0d/*9*/,0x00/*-*/,0x00/*����*/};
...
void Init_1621(void)
{
  LCD_CS_HIGH();
	...
	Write_1621_COMMAND(B0000_0101);    // �رտ��Ź�
