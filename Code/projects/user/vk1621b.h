...
#define TimeHS_ON(Num)  DplyData.AFED_1 = seg_afed[Num]; DplyData.BGC_1 = seg_bgc[Num]  // 时间小时十位
#define TimeHG_ON(Num)  DplyData.AFED_2 = seg_afed[Num]; DplyData.BGC_2 = seg_bgc[Num]  // 时间小时个位
#define TimeMS_ON(Num)  DplyData.AFED_3 = seg_afed[Num]; DplyData.BGC_3 = seg_bgc[Num]  // 时间分钟十位
#define TimeMG_ON(Num)  DplyData.AFED_4 = seg_afed[Num]; DplyData.BGC_4 = seg_bgc[Num]  // 时间分钟个位
...
#define KEY_LOCK_CLOSE_SEG_ON DplyData.S28 = 1   // 按键锁图标
...
#define WIFI_SEG_ON DplyData.S26 = 1   // Wi-Fi 图标
