...
//	}
	...
	/* External DC power insertion should light the backlight immediately even
	 * if the system has not yet completed a sleep-resume state transition. */
	display_active = (power.status == POWER_ON) || app_power_is_dcin_connected();
